...
# ADJUSTED FOR COLLABWAVE: Knex migration protection
...
case "$PATH_LC" in
  ...
  # ============= ADJUSTED FOR COLLABWAVE (Node/Express + React) =============
  */backend/migrations/*|backend/migrations/*)
    emit deny "Migrations do Knex nao devem ser editadas manualmente. Usa: npm run migrate:make -- {nome} (a partir de backend/)" ;;
